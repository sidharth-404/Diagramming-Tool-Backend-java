...
//        canvasImage.setImageData("mockedImageData");
//
...
//        assertThat(savedCanvasImage.getImageData()).isEqualTo("mockedImageData");
//    }
//
//    @Test
...
//        existingCanvasImage.setImageData("existingImageData");
//
//        CanvasImage updatedCanvasImage = new CanvasImage();
//        updatedCanvasImage.setId(id);
//        updatedCanvasImage.setImageData("updatedImageData");
//
//        // Mock repository behavior
...
//        assertThat(result.getImageData()).isEqualTo("updatedImageData");
//    }
//
//    @Test
